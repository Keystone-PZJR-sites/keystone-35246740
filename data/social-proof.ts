...
export const SOCIAL_SLIDES: SocialProofSlide[] = [
  {
    video:          { desktop: { webm: `${V}/socialproof-01-desktop.webm`, mp4: `${V}/socialproof-01-desktop.mp4` }, mobile: { webm: `${V}/socialproof-01-mobile.webm`, mp4: `${V}/socialproof-01-mobile.mp4` }, mobilePoster: `${V}/socialproof-01-mobile-poster.webp`, desktopPoster: `${V}/socialproof-01-desktop-poster.webp` },
    cardBgColor:    '#56A6FF',
    textColor:      '#0F223D',
  ...
  {
    video:          { desktop: { webm: `${V}/socialproof-02-desktop.webm`, mp4: `${V}/socialproof-02-desktop.mp4` }, mobile: { webm: `${V}/socialproof-02-mobile.webm`, mp4: `${V}/socialproof-02-mobile.mp4` }, mobilePoster: `${V}/socialproof-02-mobile-poster.webp`, desktopPoster: `${V}/socialproof-02-desktop-poster.webp` },
    cardBgColor:    '#D8C2FF',
    textColor:      '#2F0D3F',
  ...
  {
    video:          { desktop: { webm: `${V}/socialproof-03-desktop.webm`, mp4: `${V}/socialproof-03-desktop.mp4` }, mobile: { webm: `${V}/socialproof-03-mobile.webm`, mp4: `${V}/socialproof-03-mobile.mp4` }, mobilePoster: `${V}/socialproof-03-mobile-poster.webp`, desktopPoster: `${V}/socialproof-03-desktop-poster.webp` },
    cardBgColor:    '#F38BB0',
    textColor:      '#3D1324',
  ...
  {
    video:          { desktop: { webm: `${V}/socialproof-04-desktop.webm`, mp4: `${V}/socialproof-04-desktop.mp4` }, mobile: { webm: `${V}/socialproof-04-mobile.webm`, mp4: `${V}/socialproof-04-mobile.mp4` }, mobilePoster: `${V}/socialproof-04-mobile-poster.webp`, desktopPoster: `${V}/socialproof-04-desktop-poster.webp` },
    cardBgColor:    '#F2BA46',
    textColor:      '#3A2A0E',
  ...
  {
    video:          { desktop: { webm: `${V}/socialproof-05-desktop.webm`, mp4: `${V}/socialproof-05-desktop.mp4` }, mobile: { webm: `${V}/socialproof-05-mobile.webm`, mp4: `${V}/socialproof-05-mobile.mp4` }, mobilePoster: `${V}/socialproof-05-mobile-poster.webp`, desktopPoster: `${V}/socialproof-05-desktop-poster.webp` },
    cardBgColor:    '#6ECC8B',
    textColor:      '#063126',
  ...
  {
    video:          { desktop: { webm: `${V}/socialproof-06-desktop.webm`, mp4: `${V}/socialproof-06-desktop.mp4` }, mobile: { webm: `${V}/socialproof-06-mobile.webm`, mp4: `${V}/socialproof-06-mobile.mp4` }, mobilePoster: `${V}/socialproof-06-mobile-poster.webp`, desktopPoster: `${V}/socialproof-06-desktop-poster.webp` },
    cardBgColor:    '#F57E56',
    textColor:      '#3C1618',
