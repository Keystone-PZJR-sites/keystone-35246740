...
export const MOBILE_SOCIAL_THUMBNAILS: MobileSocialProofThumbnail[] = [
  { video: { webm: '/social-proof/social-proof-video-1.webm', mp4: '/social-proof/social-proof-video-1.mp4' }, width: 200, height: 112, left: 24,  top: 32,  markerSrc: '/social-proof/social-proof-marker-cross.svg', slideIndex: 0 },
  { video: { webm: '/social-proof/social-proof-video-2.webm', mp4: '/social-proof/social-proof-video-2.mp4' }, width: 144, height: 96,  left: 229, top: 164, markerSrc: '/social-proof/social-proof-marker-cross.svg', slideIndex: 1 },
  { video: { webm: '/social-proof/social-proof-video-3.webm', mp4: '/social-proof/social-proof-video-3.mp4' }, width: 168, height: 87,  left: 16,  top: 271, markerSrc: '/social-proof/social-proof-marker-cross.svg', slideIndex: 2 },
  { video: { webm: '/social-proof/social-proof-video-4.webm', mp4: '/social-proof/social-proof-video-4.mp4' }, width: 112, height: 64,  left: 265, top: 544, markerSrc: '/social-proof/social-proof-marker-cross.svg', slideIndex: 3 },
  { video: { webm: '/social-proof/social-proof-video-5.webm', mp4: '/social-proof/social-proof-video-5.mp4' }, width: 114, height: 64,  left: 16,  top: 615, markerSrc: '/social-proof/social-proof-marker-cross.svg', slideIndex: 4 },
  { video: { webm: '/social-proof/social-proof-video-6.webm', mp4: '/social-proof/social-proof-video-6.mp4' }, width: 216, height: 152, left: 147, top: 668, markerSrc: '/social-proof/social-proof-marker-cross.svg', slideIndex: 5 },
];
