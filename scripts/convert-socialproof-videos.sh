...
# Optimizes Social Proof MP4 sources into desktop and mobile web formats.
# Usage: ./scripts/convert-socialproof-videos.sh [input-directory]
# Defaults to current directory if no argument is provided.
#
# Expected names:
#   socialproof-01-desktop.mp4
#   socialproof-01-mobile.mp4
#
# Outputs keep the same simple basename:
#   converted/socialproof-01-desktop.mp4
#   converted/socialproof-01-desktop.webm
#   converted/socialproof-01-mobile.mp4
#   converted/socialproof-01-mobile.webm
...
for f in "${files[@]}"; do
  ...
  echo "  ✓ Done: ${filename}.mp4 + ${filename}.webm"
done
