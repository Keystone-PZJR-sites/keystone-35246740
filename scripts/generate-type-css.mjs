// Generates design-system/tokens/type.css from the Figma text-style data.
// Run with: node scripts/generate-type-css.mjs
...
const src = join(root, "design-system/tokens/type-styles.json");
const out = join(root, "design-system/tokens/type.css");
...
// GT Standard sets weight and optical size independently.
const TEXT_OPSZ = {
  "3xs": 24,
  "2xs": 24,
  xs: 24,
...
const lines = [];
lines.push(`/* Generated typography tokens. Do not edit directly.`);
