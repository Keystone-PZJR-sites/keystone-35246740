// ============================================================
// CARDS PREVIEW PAGE — Static preview for pixel-perfect QA
// ============================================================
// Visit /cards-preview to see all 25 work cards rendered
// without GSAP animations or Embla carousel.
// This page is for development QA only.
// ============================================================
...
const healthSalesContent = {
  messages: [
    { side: 'studio' as const, text: "Hi Jamie! Sam from X2O Studio here, so glad you reached out! Want to book a free 1:1 intro consultation? 30 minutes with one of our instructors, no class pressure. I have openings tomorrow at 10am or Thursday at 5:30pm." },
    { side: 'customer' as const, text: "Thursday works better. Is it on the reformer or just a tour?" },
    { side: 'studio' as const, text: "Thursday 5:30 it is! The session is part studio tour, part reformer workout and your instructor will run you through the basics so they can recommend the right starting point for you." },
    { side: 'customer' as const, text: "Sounds good. Anything I should send over beforehand?", timestamp: "Read: Yesterday, 10:48 AM" },
    { side: 'studio' as const, text: "Nothing required, just wear something fitted. We'll have grip socks available if you need them.\n\nYou're booked for Thursday 5:30pm with Maya, we'll send a reminder the day before. Excited to see you at X2O, Jamie!" },
  ],
};
...
const homeSalesContent = {
  messages: [
    { side: 'studio' as const, text: "Hi Alex! Thanks for reaching out to CanopyWorks. We'd love to get eyes on your trees — do you have time for a free on-site consultation this Wednesday at 9am or Friday at 2pm?" },
    { side: 'customer' as const, text: "Friday works. It's about a big oak in the backyard — not sure if it's dead or just stressed." },
    { side: 'studio' as const, text: "Friday at 2pm it is. That's a really common question and we'll be able to give you a clear read once they're on-site. The consult includes a full visual assessment and a walkthrough of what they're seeing." },
    { side: 'customer' as const, text: "Great. How long does it usually take?", timestamp: "Read: 12:48 PM" },
    { side: 'studio' as const, text: "Usually 30–45 minutes depending on the tree and how many questions you have — and there are always questions. You're confirmed for Friday at 2pm. \n\nSee you then, Alex!" },
  ],
};
...
const careSalesContent = {
  messages: [
    ...
    { side: 'studio' as const, text: "Totally got you. We do really well with anxious dogs — one at a time, no crating, usually in and out in 90 minutes. We have Saturday at 9am or Thursday at 11am. \n\nDo either of those work for you?" },
    { side: 'customer' as const, text: "Saturday at 9 is good." },
    { side: 'studio' as const, text: "Perfect. What's your pups name? And full groom or just a bath and brush?" },
    { side: 'customer' as const, text: "Rufus. \n\nWhat's the difference in price?", timestamp: "Read: 12:48 PM" },
    { side: 'studio' as const, text: "Bath and brush is $45, full groom with haircut is $65. For a first visit, a lot of anxious dogs do better starting with the bath — easier intro." },
    { side: 'customer' as const, text: "Let's do the bath and brush, then." },
    { side: 'studio' as const, text: "Saturday at 9am, bath and brush for Rufus. We'll text you when he's 20 minutes from done. See you then! 🐾" },
  ],
};
