...
export function IconProjects({ size = 20, className }: Props) {
  return (
    <svg width={size} height={size} viewBox="0 0 20 20" fill="none" aria-hidden="true" className={className} xmlns="http://www.w3.org/2000/svg">
      <path d="M15 0.5V1.75H5V0.5H15Z" fill="var(--color-brown-400, #ad8261)" />
      <path d="M16.666 3.41699V4.66699H3.33301V3.41699H16.666Z" fill="var(--color-brown-400, #ad8261)" />
      <path d="M17.084 7.58301H2.91699V15.25H9.625V16.5H1.66699V6.33301H18.334V11.041H17.084V7.58301Z" fill="var(--color-brown-400, #ad8261)" />
      <path d="M11.5 15.3352C12.5969 15.3352 13.2726 15.578 13.6823 15.9877C14.092 16.3974 14.3347 17.0731 14.3347 18.17H15.3352C15.3352 17.0731 15.578 16.3974 15.9877 15.9877C16.3974 15.578 17.0731 15.3352 18.17 15.3352V14.3347C17.0731 14.3347 16.3974 14.092 15.9877 13.6823C15.578 13.2726 15.3352 12.5969 15.3352 11.5H14.3347C14.3347 12.5969 14.092 13.2726 13.6823 13.6823C13.2726 14.092 12.5969 14.3347 11.5 14.3347V15.3352Z" fill="var(--color-brown-600, #72523b)" />
    </svg>
  );
}
...
export function IconApproach({ size = 20, className }: Props) {
  return (
    <svg width={size} height={size} viewBox="0 0 20 20" fill="none" aria-hidden="true" className={className} xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M15.2506 8.12533H11.8757V4.75033L14.7923 1.66699L15.6257 4.37533L18.334 5.20866L15.2506 8.12533Z" fill="var(--color-teal-600, #318175)" />
...
export function IconCaseStudies({ size = 20, className }: Props) {
  return (
    <svg width={size} height={size} viewBox="0 0 20 20" fill="none" aria-hidden="true" className={className} xmlns="http://www.w3.org/2000/svg">
      <path d="M15 9.95V4.5H5V7.45H8.29004L10.79 9.96L13.29 9.95H15Z" fill="var(--color-darkgray-300, #5d5a56)" />
      <path d="M15.625 3.875V10.5752H13.293L10.5312 10.5859L8.03125 8.0752H4.375V3.875H15.625ZM5.625 6.8252H8.5498L11.0479 9.33301L13.2871 9.3252H14.375V5.125H5.625V6.8252Z" fill="var(--color-darkgray-300, #5d5a56)" />
