...
/** icon-social/spotify (the 024 podcast-card marks; exported verbatim
 * from the drawn 1344 buttons `921:18381` via the console bridge
 * 2026-09-08, spec 024 §7) — 34-grid, currentColor (tints yellow/700
 * from the card). The mounts size the mark at 60% of its disc — the
 * drawn 20%-inset box (024 §7 F5). */
...
/** icon-social/youtube (the 024 podcast-card marks; exported verbatim
 * from the drawn 1344 buttons `921:18381` via the console bridge
 * 2026-09-08, spec 024 §7) — 34-grid, currentColor. */
...
/** icon-social/applepodcast (the 024 podcast-card marks; exported
 * verbatim from the drawn 1344 buttons `921:18381` via the console
 * bridge 2026-09-08, spec 024 §7) — 34-grid, currentColor. */
...
/** search (766:262) — the search module's own single-tone magnifier
 * (spec 024 §4; exported verbatim via the console bridge 2026-09-08).
 * NOT the sticker sheet's two-tone icons/search — a fourth export the
 * draft's §7 count missed (024 §9 build record). 16-grid, currentColor
 * (ink text/300 from the module). */
