    ...
    <div className={clsx('relative w-full', isDesktop && 'max-w-xl', className)}>
      ...
      >
        ...
        <button
          ...
          className={clsx(
            "inline-flex shrink-0 items-center gap-2 whitespace-nowrap rounded-xl bg-[var(--color-hero-accent)] font-['FK_Grotesk_Neue',sans-serif] tracking-[-0.01em] text-[var(--color-hero-bg)] transition-colors hover:bg-[var(--color-hero-accent-hover)]",
      ...
      {showMenu && (
        <ul
          className={clsx(
            'absolute inset-x-0 z-[60] overflow-hidden rounded-2xl border border-[var(--color-border-tertiary)] bg-[var(--color-surface-card)] py-1.5 text-left shadow-[0_24px_60px_-24px_rgba(4,32,25,0.6)]',
