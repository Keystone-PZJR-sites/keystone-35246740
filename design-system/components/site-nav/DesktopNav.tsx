...
type DesktopNavProps = Pick<
  HeroNavProps,
  'items' | 'loginLabel' | 'loginHref' | 'ctaLabel' | 'ctaHref' | 'wordmarkColor'
>;
 ...
 * wordmark, a centered navigation group, and the primary "Get Started" CTA.
 * Dropdown panels are centered under the bar.
 *
  ...
  return (
    <div className="hero-nav-bar">
      ...
      <div className="hero-nav-actions">
        ...
        <Link href={ctaHref} className="hero-nav-cta">
          {ctaLabel}
