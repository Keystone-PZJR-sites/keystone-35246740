...
import { KeystoneMark, KeystoneWordmark, SocialIcon } from '@/design-system/primitives';
...
export function OversizedFooter({
  ...
  return (
    <section ref={sectionRef} className="footer-section hidden md:block" data-theme="custom">
      ...
      {/* ================================================================
          UPPER ZONE — collage (tablet + desktop ≥985px)
          ...
          <div className="footer-lower-act2">
            {signUpState === 'success' ? (
              ...
              <form
                ...
                className="flex items-center rounded-full border border-[var(--color-text-brand-secondary,#9f3722)] p-3 w-full max-w-[480px]"
              >
