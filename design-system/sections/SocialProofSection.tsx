...
export function SocialProofSection({
  ...
  useLayoutEffect(() => {
    const ctx = gsap.context(() => {
      ...
      mm.add(
        `(prefers-reduced-motion: no-preference) and ${DESKTOP_MEDIA}`,
        () => {
                ...
                <div key={i} className="sp-slide">
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <source src={slide.video.desktop.webm} type="video/webm" media={DESKTOP_MEDIA} />
                        <source src={slide.video.desktop.mp4} type="video/mp4" media={DESKTOP_MEDIA} />
                      </video>
                      <div
