...
export function EveryChannel({ line1, line2, line3, videoSrcs, pills }: EveryChannelProps) {
  ...
  const renderLine = (text: string, ref: React.RefObject<HTMLParagraphElement | null>) => (
    <p
      ref={ref}
      className="font-['FK_Screamer',sans-serif] font-bold uppercase leading-[0.82] not-italic text-[var(--color-hero-text,#f0eee6)]"
      style={LINE_P_STYLE}
    >
  ...
  return (
    <div ref={wrapperRef} className="relative hidden md:block">
      <section
        ...
        className="relative min-h-[calc(100svh+2px)] w-full overflow-hidden bg-[var(--color-hero-bg,#042019)] flex items-center justify-center"
      ...
      >
        ...
        {sortedPills.map((pill, i) => (
          ...
          >
            <div className="shrink-0 bg-[var(--color-hero-text,#f0eee6)]" style={{ width: 10, height: 10 }} />
            <span
              className="whitespace-nowrap font-['FK_Grotesk_Neue',sans-serif] font-normal text-[var(--color-hero-text,#f0eee6)]"
